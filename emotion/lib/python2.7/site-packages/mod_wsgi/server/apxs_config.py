...
if WITH_HTTPD_PACKAGE:
    ...
    BINDIR = '/usr/local/lib/python3.6/site-packages/mod_wsgi_packages/httpd/bin'
    SBINDIR = '/usr/local/lib/python3.6/site-packages/mod_wsgi_packages/httpd/bin'
    LIBEXECDIR = '/usr/local/lib/python3.6/site-packages/mod_wsgi_packages/httpd/modules'
    SHLIBPATH = ''
